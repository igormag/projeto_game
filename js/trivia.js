...
var game = new function () {
    ...
    this.loadData = function () {
       ...
       /* FILL GAME TEXT */
        $("#botaoStart").html("" + value(questions.splash_page_button_continue_text));
...
//        tPlay(sounds.lost, PRIORITY_NORMAL);
    ...
    /* ANIMATIONS */
    this.animacaoCapa = function () {
        /* Animação dos objetos da capa*/
        TweenMax.from(".logo_LEO", 2, {opacity:0});        
        TweenMax.from(".titulo_LEO", 1, {delay: 0.5, x:460, opacity:0});
        TweenMax.fromTo("#botaoStart", 0.5, {opacity:0, scale: 0.5}, {opacity:1, scale: 1, delay:1});

        /* ### Animação do botão ###
        var t = TweenMax.fromTo("#botaoStart", 1, {color:"#0ff"}, {color:"#102832", ease:Circ.easeOut, repeat:-1});
        t.progress(1).play();   

        ###Pausa e continua animação do botão com o mouse over### */
        document.getElementById("botaoStart").addEventListener("mouseover", mouseOverBotao);
        document.getElementById("botaoStart").addEventListener("mouseout", mouseOutBotao);
    ...
    this.animacaoIntro = function () {
        TweenMax.from(".description", 1, {delay: 0.5, x:460, opacity:0});
        TweenMax.fromTo("#step2continuebutton", 0.5, {opacity:0, scale: 0.5}, {opacity:1, scale: 1, delay:1});
        TweenMax.to(".gamebody", 1, {delay: 0.5, backgroundColor:"#215d82"});
        TweenMax.to(".game", 1, {delay: 0.5, backgroundColor:"#215d82"});
    };    
